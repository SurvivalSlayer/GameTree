 ...
 */
class getImageAnnoncesRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ImageAnnoncesRepository.php';

        return $container->privates['App\\Repository\\ImageAnnoncesRepository'] = new \App\Repository\ImageAnnoncesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
